...
export default {
  useNextSeoProps() {
    ...
    if (asPath !== "/") {
      return {
        titleTemplate: "%s - Deri Documentation",
      };
    }
  },
  logo: () => (
  ...
  logoLink: "/",
  docsRepositoryBase: `https://github.com/deri-kurniawan/deri/tree/main/docs`,
  project: {
    link: "https://github.com/deri-kurniawan/deri",
  },
  gitTimestamp: ({ timestamp }) => (
    <p>Last updated at {new Date(timestamp).toLocaleDateString()}</p>
  ),
  footer: {
    text: (
      <p>
